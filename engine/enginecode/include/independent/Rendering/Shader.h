...
namespace Engine {
	...
	public:
		...
		virtual void uploadMat4(const std::string& name, int count, bool transpose, glm::mat4 fnMat4) = 0;
		...
		static inline Shader* create(const std::string& filepath) { return nullptr; } //!<Create, compile and link API specific shader from single filepath
